(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('util'), require('stream'), require('path'), require('http'), require('https'), require('url'), require('fs'), require('assert'), require('tty'), require('os'), require('zlib')) :
  typeof define === 'function' && define.amd ? define(['util', 'stream', 'path', 'http', 'https', 'url', 'fs', 'assert', 'tty', 'os', 'zlib'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.GLWidget = factory(global.util, global.stream, global.path, global.http, global.https, global.url, global.fs, global.assert, global.tty, global.os, global.zlib));
})(this, (function (util, stream, path, http, https, url, fs, assert, tty, os, zlib) { 'use strict';
  ...
  var parseUrl$1 = url__default["default"].parse;
  ...
  // make it a Stream
  util__default["default"].inherits(FormData$1, combined_stream);
