import { ResBodyDashboardVo, ResBodyBizMenuVo, ResBodyBizSchemaVo, ResBodyAppPackageVo, ResBodyListAppPackageVo, ResBodyListFunTreeVo, ResBodyListBizSchemaVo } from '../api/model';
/**
 * app-controller
 */
