import { ResBodystring, ResBodyOrganizationVo, ResBodyListOrganizationVo, OrgSyncRecordQueryVo, ResBodyPageVOOrgSyncRecordVo, ResBodyVoid, OrganizationVo, SyncOrgVo } from '../api/model';
/**
