...
class BizServiceController {
  ...
  listServiceTree(): Mock.MockjsMock {
  ...
  listAll(): Mock.MockjsMock {
    return Mock.mock({"bizKey":"@ctitle(10, 20)","code":"@integer(0, 100)","data|20":[{"categroyId":"@ctitle(10, 20)","code":"@ctitle(10, 20)","id":"@ctitle(10, 20)","name":"@cname","protocolType":"@ctitle(10, 20)"}],"msg":"@ctitle(10, 20)","traceId":"@ctitle(10, 20)"});
  }
...
// @ts-ignore
export default new BizServiceController();
